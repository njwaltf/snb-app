...
@section('container')
    ...
    <div class="row">
        <div class="col-lg-12 my-3">
            <h2><a href="/dashboard/reports"><i class="ti ti-arrow-left"></i></a> Edit Laporan</h2>
        </div>
    </div>
    <form action="/dashboard/reports/{{ $report->id }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <p>Ceritakan serta deskripsikan bagaimana kejadian tersebut dengan bahasa yang sopan
                                        serta
                                        jelas.</p>
                                    <input id="bully_desc" type="hidden" name="bully_desc"
                                        value="{{ old('bully_desc', $report->bully_desc) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select @error('bully_type_id') is-invalid @enderror"
                                        ...
                                        @foreach ($bully_types as $bully_type)
                                            <option
                                                value="{{ $bully_type->id }}"@if ($report->bully_type_id === $bully_type->id) selected @endif>
                                                {{ $bully_type->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('bully_type_id')
                                        <p class="invalid" style="color: red">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select class="form-select @error('isAnonym') is-invalid @enderror"
                                        ...
                                        <option value="{{ 0 }}"
                                            @if ($report->isAnonym === 0) selected @endif>Publik</option>
                                        <option value="{{ 1 }}"
                                            @if ($report->isAnonym === 1) selected @endif>Anonim</option>
                                    </select>
                                    @error('isAnonym')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control @error('suspect_total') is-invalid @enderror"
                                        id="suspect_total" name="suspect_total"
                                        value="{{ old('suspect_total', $report->suspect_total) }}">
                                    @error('suspect_total')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('suspect_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('suspect_name', $report->suspect_name) }}">
                                    @error('suspect_name')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control @error('victim_total') is-invalid @enderror"
                                        id="victim_total" name="victim_total"
                                        value="{{ old('victim_total', $report->victim_total) }}">
                                    @error('victim_total')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('victim_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('victim_name', $report->victim_name) }}">
                                    @error('victim_name')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        id="date" name="date" value="{{ old('date', $report->date) }}">
                                    @error('date')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control @error('place') is-invalid @enderror"
                                        id="place" name="place" value="{{ old('place', $report->place) }}">
                                    @error('place')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number"
                                        ...
                                        id="incident_total" name="incident_total"
                                        value="{{ old('incident_total', $report->incident_total) }}">
                            ...
                            <div class="col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="file"
                                        ...
                                        id="evidence_img" name="evidence_img" value=""
                                        onchange="previewImage(event);">
                                    @if ($report->evidence_img > 0)
                                        <img id="preview-selected-image" class="img-fluid m-2" width="400"
                                            height="250" src="{{ asset('storage/' . $report->evidence_img) }}">
                                    @else
                                        <img id="preview-selected-image" class="img-fluid m-2" width="400"
                                            height="250">
                                    @endif
